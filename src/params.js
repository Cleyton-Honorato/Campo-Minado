...
const Params = {
    ...
    getColumnsAmout() {      // dimensão das columas 
    ...
    getRowAmout() {         // dimensão das linhas 
        ...
        return Math.floor(bordeheigth / this.headerRatio)          // altura dividida pelo tamanho do block
    }
}
